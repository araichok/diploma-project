...
// PreferenceServiceClient is the messaging API for PreferenceService service.
//
...
type PreferenceServiceClient interface {
	...
	GetPreferenceHistory(ctx context.Context, in *UserPreferenceRequest, opts ...grpc.CallOption) (*PreferenceHistoryResponse, error)
...
func (c *preferenceServiceClient) GetPreferenceHistory(ctx context.Context, in *UserPreferenceRequest, opts ...grpc.CallOption) (*PreferenceHistoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type PreferenceServiceServer interface {
	...
	GetPreferenceHistory(context.Context, *UserPreferenceRequest) (*PreferenceHistoryResponse, error)
...
func (UnimplementedPreferenceServiceServer) GetPreferenceHistory(context.Context, *UserPreferenceRequest) (*PreferenceHistoryResponse, error) {
...
func _PreferenceService_GetPreferenceHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PreferenceServiceServer).GetPreferenceHistory(ctx, req.(*UserPreferenceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
