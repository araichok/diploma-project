...
const file_proto_user_proto_rawDesc = "" +
	...
	"\n" +
	"DeleteUser\x12\x17.user.DeleteUserRequest\x1a\x18.user.DeleteUserResponseB\x10Z\x0e./proto/userpbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	5, // 0: user.LoginResponse.user:type_name -> user.UserResponse
	...
	5, // 6: user.UserService.Register:output_type -> user.UserResponse
	6, // 7: user.UserService.Login:output_type -> user.LoginResponse
	5, // 8: user.UserService.GetProfile:output_type -> user.UserResponse
