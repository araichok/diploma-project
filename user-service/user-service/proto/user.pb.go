...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\"T\n" +
	"\x04User\x12\x0e\n" +
	...
	".user.UserR\x04user2\xed\x01\n" +
	"\vUserService\x129\n" +
	"\fRegisterUser\x12\x15.user.RegisterRequest\x1a\x12.user.UserResponse\x123\n" +
	"\tLoginUser\x12\x12.user.LoginRequest\x1a\x12.user.UserResponse\x123\n" +
	"\aGetUser\x12\x14.user.GetUserRequest\x1a\x12.user.UserResponse\x129\n" +
	"\n" +
	"UpdateUser\x12\x17.user.UpdateUserRequest\x1a\x12.user.UserResponseB\x17Z\x15user-service/proto;pbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	1, // 1: user.UserService.RegisterUser:input_type -> user.RegisterRequest
	2, // 2: user.UserService.LoginUser:input_type -> user.LoginRequest
	...
	5, // 6: user.UserService.LoginUser:output_type -> user.UserResponse
