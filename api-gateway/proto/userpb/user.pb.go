...
func (x *CountUsersResponse) GetTotalUsers() int32 {
	if x != nil {
		return x.TotalUsers
	}
	return 0
...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\"\xa2\x01\n" +
	...
	"\n" +
	"CountUsers\x12\x17.user.CountUsersRequest\x1a\x18.user.CountUsersResponseB\x10Z\x0e./proto/userpbb\x06proto3"
...
var file_proto_user_proto_goTypes = []any{
	...
	(*CountUsersRequest)(nil),      // 13: user.CountUsersRequest
	(*CountUsersResponse)(nil),     // 14: user.CountUsersResponse
}
var file_proto_user_proto_depIdxs = []int32{
	...
	13, // 9: user.UserService.CountUsers:input_type -> user.CountUsersRequest
	6,  // 10: user.UserService.Register:output_type -> user.UserResponse
	2,  // 11: user.UserService.Login:output_type -> user.LoginResponse
	6,  // 12: user.UserService.GetProfile:output_type -> user.UserResponse
	6,  // 13: user.UserService.UpdateUser:output_type -> user.UserResponse
	7,  // 14: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
	2,  // 15: user.UserService.RefreshToken:output_type -> user.LoginResponse
	10, // 16: user.UserService.Logout:output_type -> user.LogoutResponse
	12, // 17: user.UserService.ChangePassword:output_type -> user.ChangePasswordResponse
	14, // 18: user.UserService.CountUsers:output_type -> user.CountUsersResponse
